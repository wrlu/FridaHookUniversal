...
processes_to_hook = [
    # Android
    # {'identifier': 'com.sgcc.wsgw.cn', 'name': '网上国网'},

    # iOS
    {'identifier': 'com.kuaishou.nebula', 'name': '快手极速版'},
]
...
js_modules = [
    {'platform': 'ios', 'name': 'ssl', 'on': on_message},
]
...
def init_device():
    ...
    if i == 4:
        select = 4
        Log.warn('Auto select USB device...')
    elif i == 1 or i == 2:
        select = 1
...
if __name__ == '__main__':
    try:
        ...
        for per_hook_process in processes_to_hook:
            ...
            Log.info('Attach application: ' + per_hook_process['name'])
